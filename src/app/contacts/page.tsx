    ...
    <div className="w-full h-screen bg-[#0A1128]">
        ...
        <div className="w-full h-8/12 sm:h-7/12 flex flex-col fixed justify-center items-center lg:justify-start lg:items-start gap-12 lg:ml-20 lg:mt-10 z-30">
             <div className="flex flex-col lg:justify-start lg:items-start justify-center items-center gap-12">
                <div className="justify-start max-sm:text-center text-neutral-50 max-lg:text-6xl text-7xl font-bold font-['Inter']">Pagina de Contatos</div>
                <div className="w-5/12 max-lg:text-center text-neutral-50/75 max-lg:text-lg text-xl font-normal font-['Inter'] leading-relaxed">Por favor crie a pagina de rios aqui</div>
            </div>
        </div>
        <Footer/>
    </div>
