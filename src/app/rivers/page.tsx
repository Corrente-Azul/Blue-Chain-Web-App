  ...
  return (
    <div className="flex flex-col items-center w-full xl:h-screen h-full bg-[#0A1128]">
      ...
      <div className="w-full xl:h-7/12 h-auto flex max-xl:flex-col-reverse justify-center rounded-2xl xl:gap-5 gap-10 items-center 2xl:px-20 px-5 m-10 z-30">
          { rivers.map((x) =>{
            return(
              <div className="xl:w-1/4 xl:h-[30rem] md:w-[40rem] md:h-[50rem] sm:w-[30rem] sm:h-[40rem] w-[25rem] h-[30rem] flex flex-col border-solid border-2 border-[#034078] rounded-2xl p-5" key={x.id}>
                ...
                <div className="h-2/7 w-full flex">
                  <div className="flex flex-col w-2/3 justify-center items-start gap-5">
                    <div className=" text-neutral-50 max-lg:text-xl text-xl font-bold font-['Inter']">{x.name}</div>
                    <div className="flex flex-row justify-center items-center gap-2">
                      <div className=" text-neutral-50/75 text-base font-normal font-['Inter']">Indice: {
                  ...
                  <div className="flex flex-col w-1/3 justify-center">
                    <Link href={x.id != undefined ? `/inforivers/${x.id}` : "/map"}>
                      <div className="w-24 h-12 bg-white flex justify-center items-center rounded-2xl">
                        <div className="justify-center text-slate-900 text-sm font-medium font-['Inter'] leading-9">Ver Detalhes</div>
                      </div>
                    </Link>
                  </div>
                </div>
